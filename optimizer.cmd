...
echo.						%p%╚═╝     ╚═╝   ╚═╝   ╚═╝  ╚═╝╚══════╝╚══════╝╚══════╝ ╚═════╝ ╚═╝        ╚═╝   ╚═╝╚═╝     ╚═╝╚═╝╚══════╝╚══════╝╚═╝  ╚═╝%b%               
echo.                                                    %b%"═══════════════════════════════════════════════════════════════════════════════════════════════════════════"%w%
echo.                                                                                           %W%   Optimizer is not running as Admin!
echo.                                         
...
echo.                                                                       %p%   ╚═╝   ╚═╝  ╚══════╝╚══════╝ ╚════╝  ╚════╝ ╚═╝     ╚═╝╚══════╝  
echo.                             %b%"════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════"%w%
echo.                                      I am not responsible for any problems this may cause to your pc, if you encounter any, feel free to contact me on Discord: myklewz 
echo.
echo.                             %b%"════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════"%w%
...
chcp 437 >nul 2>&1
powershell "Checkpoint-Computer -Description 'MyklezOptimizer Restore Point'
powershell "&  {Add-Type -AssemblyName System.Windows.Forms; [System.Windows.Forms.MessageBox]::Show('Restore point completed successfully, press "OK" to continue', 'MyklezWindowsOptimizer', 'Ok', [System.Windows.Forms.MessageBoxIcon]::Information);}"
chcp 65001 >nul 2>&1 
cls
goto :resources
...
if not exist "C:\myop\myopPowerPlan.pow" (
goto download
)
if not exist "C:\myop\Autoruns.exe" (
goto download
)
if not exist "C:\myop\myopNVPI.nip" (
goto download
)
if not exist "C:\myop\MSI_Utility.exe" (
goto download
)
if not exist "C:\myop\Windows_Update_Blocker.exe" (
goto download
)
if not exist "C:\myop\Nvidia_Profile_Inspector_2.4.0.19.exe" (
goto download
) 
...
:Download
chcp 437 >nul 2>&1
powershell "&  {Add-Type -AssemblyName System.Windows.Forms; [System.Windows.Forms.MessageBox]::Show('Resources Not found or out of date, Press "OK" To download them', 'MyklezWindowsOptimizer', 'Ok', [System.Windows.Forms.MessageBoxIcon]::Information);}"
chcp 65001 >nul 2>&1
...
echo.                                                                  %p%╚═╝  ╚═╝╚══════╝╚═════╝  ╚════╝  ╚═════╝ ╚═╝  ╚═╝ ╚════╝ ╚══════╝╚═════╝ 
echo.
echo. %w%- Downloading the Myklez Power Plan... %g%(Part of the Resources Used by the tool. You can find them in the C:\myop folder) %b% 
echo.
echo [======                       14.5%                         ]
echo.
chcp 437 >nul 2>&1
curl -g -k -L -# -o "C:\myop\myopPowerPlan.pow" "https://raw.githubusercontent.com/Myklewz/WODeps/refs/heads/main/myopPowerPlan.pow" >nul 2>&1
chcp 65001 >nul 2>&1
timeout 1 > nul
cls
echo.
...
echo.                                                                  %p%╚═╝  ╚═╝╚══════╝╚═════╝  ╚════╝  ╚═════╝ ╚═╝  ╚═╝ ╚════╝ ╚══════╝╚═════╝ 
echo.
echo. %w%- Downloading Autoruns... %g%(Part of the Resources Used by the tool. You can find them in the C:\myop folder) %b% 
echo. 
echo [==================           30.5%                         ]
echo.
chcp 437 >nul 2>&1
curl -g -k -L -# -o "C:\myop\Autoruns.exe" "https://raw.githubusercontent.com/Myklewz/WODeps/refs/heads/main/Autoruns.exe" >nul 2>&1  
...
echo.                                                                  %p%╚═╝  ╚═╝╚══════╝╚═════╝  ╚════╝  ╚═════╝ ╚═╝  ╚═╝ ╚════╝ ╚══════╝╚═════╝ 
echo.
echo. %w%- Downloading Nvidia Profile Inspector... %g%(Part of the Resources Used by the tool. You can find them in the C:\myop folder) %b% 
echo.
echo [=============================51.0%                         ]
echo.
chcp 437 >nul 2>&1
curl -g -k -L -# -o "C:\myop\Nvidia_Profile_Inspector_2.4.0.19.exe" "https://raw.githubusercontent.com/Myklewz/WODeps/refs/heads/main/Nvidia_Profile_Inspector_2.4.0.19.exe" >nul 2>&1
...
echo.                                                                  %p%╚═╝  ╚═╝╚══════╝╚═════╝  ╚════╝  ╚═════╝ ╚═╝  ╚═╝ ╚════╝ ╚══════╝╚═════╝ 
echo.
echo. %w%- Downloading Nvidia Profile Inspector Config... %g%(Part of the Resources Used by the tool. You can find them in the C:\myop folder) %b% 
echo.
echo [=============================69.0%============             ]
echo.
chcp 437 >nul 2>&1
curl -g -k -L -# -o "C:\myop\myopNVPI.nip" "https://raw.githubusercontent.com/Myklewz/WODeps/refs/heads/main/myopNVPI.nip" >nul 2>&1  
chcp 65001 >nul 2>&1
timeout 1 > nul
cls
echo.
...
echo.                                                                  %p%╚═╝  ╚═╝╚══════╝╚═════╝  ╚════╝  ╚═════╝ ╚═╝  ╚═╝ ╚════╝ ╚══════╝╚═════╝ 
echo.
echo. %w%- Downloading the Windows Update Blocker Utility... %g%(Part of the Resources Used by the tool. You can find them in the C:\myop folder) %b% 
echo.                                                     
echo. [=============================85.0%===================     ]
echo.
chcp 437 >nul 2>&1
curl -g -k -L -# -o "C:\myop\Windows_Update_Blocker.exe" "https://raw.githubusercontent.com/Myklewz/WODeps/refs/heads/main/Windows_Update_Blocker.exe" >nul 2>&1  
...
echo.                                                                  %p%╚═╝  ╚═╝╚══════╝╚═════╝  ╚════╝  ╚═════╝ ╚═╝  ╚═╝ ╚════╝ ╚══════╝╚═════╝ 
echo.
echo. %w%- Downloading the MSI Mode Utility... %g%(Part of the Resources Used by the tool. You can find them in the C:\myop folder) %b% 
echo.
echo. [=============================100.0%=======================]
echo.
chcp 437 >nul 2>&1
:: https://forums.guru3d.com/threads/windows-line-based-vs-message-signaled-based-interrupts-msi-tool.378044/
curl -g -k -L -# -o "C:\myop\MSI_Utility.exe" "https://raw.githubusercontent.com/Myklewz/WODeps/refs/heads/main/MSI_Utility.exe" >nul 2>&1  
timeout 1 > nul
powershell "&  {Add-Type -AssemblyName System.Windows.Forms; [System.Windows.Forms.MessageBox]::Show('Downloaded resources successfully, Press "OK" To continue to the menu', 'MyklezWindowsOptimizer', 'Ok', [System.Windows.Forms.MessageBoxIcon]::Information);}"
chcp 65001 >nul 2>&1
cls
goto menu
...
echo.                                                                                                                                                                                 
echo.                                                  %p%%p%%p%%p%                                         %p%[%w%10%p%]%w% Network Tweaking           
echo.                                                                                                                                                                                 
echo.                                        %b%"════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════"%w%
echo.                                                                                                                                                                                 
echo.                                                  			%p%[%w%F%p%]%w% Fixes and Reverts                %p%[%w%R%p%]%w% Use Restore Point
echo.                                                                                                                                                                                 
echo.                                                  			%p%[%w%P%p%]%w% Patch Notes                      %p%[%w%X%p%]%w% Exit The Utility                       
echo.
echo.                                                                                  %p%%p%%p%%g%  MyklezOptimizer v0.1                   
echo.                                        %b%"════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════"%w%
...
if /i %input% == Restore goto RestorePoint
...
echo.
chcp 437 >nul 2>&1
powershell "&  {Add-Type -AssemblyName System.Windows.Forms; [System.Windows.Forms.MessageBox]::Show('Make sure to restart your PC so the optimizations properly apply. Press "OK" to exit, Thank you for using the MyklezOptimizer!', 'MyklezWindowsOptimizer', 'Ok', [System.Windows.Forms.MessageBoxIcon]::Information);}"
chcp 65001 >nul 2>&1
cls
exit
...
echo.                                     %b%"═══════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════"%w% 
echo.
echo.                                                    %p%[%w%B%p%]%w% Bufferbloat Test
echo.
echo.                                     %b%"═══════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════"%w% 
echo.    
...
:n14
chcp 437 >nul 2>&1
powershell "&  {Add-Type -AssemblyName System.Windows.Forms; [System.Windows.Forms.MessageBox]::Show('!WARNING! You can only use this if you are on ethernet, if you are on wifi, press "M" on the next page, 'MyklezOptimizer', 'Ok', [System.Windows.Forms.MessageBoxIcon]::Information);}"
chcp 65001 >nul 2>&1
...
:7war
chcp 437 >nul 2>&1
powershell "&  {Add-Type -AssemblyName System.Windows.Forms; [System.Windows.Forms.MessageBox]::Show('Note: If you want to revert anything, you can do it in the revert category on the main page of the utility', 'MyklezWindowsOptimizer', 'Ok', [System.Windows.Forms.MessageBoxIcon]::Information);}"
chcp 65001 >nul 2>&1
...
echo.                                            %p%╚═╝  ╚═╝ ╚═════╝    ╚═╝    ╚════╝ ╚═╝  ╚═╝ ╚═════╝ ╚═╝  ╚══╝╚═════╝ 
chcp 437 >nul 2>&1
powershell "&  {Add-Type -AssemblyName System.Windows.Forms; [System.Windows.Forms.MessageBox]::Show('In the autoruns app, make sure to go into the LOGON Category, press "OK" to continue', 'MyklezWindowsOptimizer', 'Ok', [System.Windows.Forms.MessageBoxIcon]::Information);}"
chcp 65001 >nul 2>&1

start C:\myop\Autoruns.exe
echo.
echo.
echo.
echo.                                                                                  %b%╔═══════════════════════════════════════════════════════════════╗
...
echo.                                            %p% ╚═════╝ ╚═╝     ╚═════╝ ╚═╝  ╚═╝   ╚═╝   ╚══════╝  ╚═════╝ ╚══════╝ ╚════╝  ╚════╝ ╚═╝  ╚═╝╚══════╝╚═╝  ╚═╝
chcp 437 >nul 2>&1
powershell "&  {Add-Type -AssemblyName System.Windows.Forms; [System.Windows.Forms.MessageBox]::Show('Note: Disabling Windows Updates will break Microsoft store, if you want to use it again simply press "Enable" in windows update blocker ', 'MyklezWindowsOptimizer', 'Ok', [System.Windows.Forms.MessageBoxIcon]::Information);}"
chcp 65001 >nul 2>&1
start C:\myop\Windows_Update_Blocker.exe
echo. 
echo.
echo.
echo.                                                                                  %b%╔═══════════════════════════════════════════════════════════════╗
...
:5war
chcp 437 >nul 2>&1
powershell "&  {Add-Type -AssemblyName System.Windows.Forms; [System.Windows.Forms.MessageBox]::Show('Do NOT do these if your pc has bad overheating issues', 'MyklezWindowsOptimizer', 'Ok', [System.Windows.Forms.MessageBoxIcon]::Information);}"
timeout /t 1 /nobreak > nul
chcp 65001 >nul 2>&1
...
if /i %input% == S cls & goto gamemode
...
echo.                                                                             
echo.                                                               %b%"═════════════════════════════════════════════════════════════════════════════════════════════"%w%
echo.                                                                           I recommend Enabling game mode on windows 11, but Disabling it on windows 10                                                
echo.                                                               %b%"═════════════════════════════════════════════════════════════════════════════════════════════"%w%
         
set /p input=:
if /i %input% == 1 goto gmodeOn
if /i %input% == 2 goto gmodeOff
if /i %input% == X cls & goto msi
...
:2war
chcp 437 >nul 2>&1
powershell "&  {Add-Type -AssemblyName System.Windows.Forms; [System.Windows.Forms.MessageBox]::Show('Do NOT do these if your pc has overheating issues', 'MyklezWindowsOptimizer', 'Ok', [System.Windows.Forms.MessageBoxIcon]::Information);}"
timeout /t 1 /nobreak > nul
chcp 65001 >nul 2>&1
:2
...
echo.                                             
echo.                                                            %p%[%w%1%p%]%w% Apply optimized Power Plan              
echo.                                                                                           
...
echo %w% Import Power Plan%b%
powercfg -import "C:\myop\myopPowerPlan"
powercfg.cpl
...
cls
echo %w% Import Power Plan%b%
powercfg -import "C:\myop\myopPowerPlan.pow"
powercfg.cpl
timeout /t 1 /nobreak > NUL
echo.
echo.	
...
echo %w% - Applying Nvidia Profile Inspector Profile %g%(optimizes nvidia control panel 3D settings and much more) %b%
start "" /wait "C:\myop\Nvidia_Profile_Inspector_2.4.0.19.exe" "C:\myop\myopNVPI.nip" 
